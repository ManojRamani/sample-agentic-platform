...
from agentic_platform.agent.agentic_chat_enhanced.controller import agentic_chat_controller
...
app = FastAPI(title="Agentic Chat Enhanced Agent")

# Configure middleware
configuration_server_middleware(app, path_prefix="/api/agentic-chat-enhanced")
